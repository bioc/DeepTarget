...
DOI="ibrutinib"
GOI="BTK"
out <- DTR (DN=DOI,GN=GOI,Pred=Pred.d[14,], Exp=d.expr,DRS= DRS,GES=KO.GES,CutOff= 2)
print(out)
...
plotSim(dx=sim.LowExp.Pval[,8],dy=sim.LowExp.Strength[,8],clr=colorRampPalette(c("lightblue",'darkblue')), plot=TRUE)
